<template>
  ...
  >
    ...
    <div class="m-option-dropdown__body" v-if="isShow && parent == 'AccountObject'">
      <div class="m-option-dropdown__item" @click="Show">Xem</div>
      <div class="m-option-dropdown__item" @click="Modify">Sửa</div>
    ...
    <div class="m-option-dropdown__body" v-if="isShow && parent == 'CaPayment'">
