...
using Required = MISA.AMIS.CORE.Entities.Required;
...
namespace MISA.AMIS.CORE.Sevices
{
    public class BaseService<TEntity> : IBaseService<TEntity> where TEntity : BaseEntity
    {
        ...
        {
            _serviceResult.Data = _baseRepository.GetEntityCode();
            return _serviceResult;
        ...
        //public void SaveMasterDetail (MasterDetailEntity entity)
        //{
        //    var masterEntity = Convert.ChangeType(entity.MasterEntity.Entity, Type.GetType(entity.MasterEntity.Type));
        //}
        ...
        {
            _serviceResult.Data = _baseRepository.GetByEntityCode(EntityCode);
            return _serviceResult;
        }
        ...
        {
            _serviceResult.Data = _baseRepository.DeleteMultipleRecords(listId);
            return _serviceResult;
        }
        ...
        {
            _serviceResult.Data = _baseRepository.GetMasterDetailById(entityId);
            return _serviceResult;
        }

        public ServiceResult GetMasterDetailByCode(string entityCode)
        {
            _serviceResult.Data = _baseRepository.GetMasterDetailByCode(entityCode);
            return _serviceResult;
        }

   

        //public ServiceResult SaveMasterDetail(MasterDetailEntity entity)
        //{
        //    //var masterEntity = entity.MasterEntity.Entity.ToObject(Type.GetType(entity.MasterEntity.Type));
        //    //var jobjectMasterEntity = JObject.FromObject(entity.MasterEntity.Entity);
        //    var masterEntity = JObject.FromObject(entity.MasterEntity.Entity).ToObject(Type.GetType("MISA.AMIS.CORE.Entities." + entity.MasterEntity.Type));
        //    //var masterEntity = Convert.ChangeType(entity.MasterEntity.Entity, Type.GetType("MISA.AMIS.CORE.Entities." + entity.MasterEntity.Type));


        //    var detailEntities = new List<object>();
        //    foreach (var detail in entity.DetailEntity.Entity)
        //    {
        //        //var detailObject = (BaseEntity)(detail.ToObject(Type.GetType(entity.DetailEntity.Type)));
        //        var detailObject = JObject.FromObject(detail).ToObject(Type.GetType("MISA.AMIS.CORE.Entities." + entity.DetailEntity.Type));
        //        var a = JsonConvert.DeserializeObject<JObject>(JsonConvert.SerializeObject(detail));
        //        detailEntities.Add(detailObject);
        //    }
        //    return _serviceResult;
        //}
    }
